...
Original file is located at
    https://colab.research.google.com/drive/1aoeWcfDzPt6hoTz7iWjCcktLhdde709g
"""
...
imputed_female_count = sum(1 for record in data if record.get("patientDetails", {}).get("gender", mode_gender) == "F")
...
medicine_counter = Counter(med["medicineName"] for record in data for med in record.get("consultationData", {}).get("medicines", []))
...
print(f"Pearson Correlation: {rounded_correlation}")